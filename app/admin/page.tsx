      ...
      <div className="mx-auto max-w-[1380px]">
        <div className="mb-8 flex flex-col gap-4 border-b border-white/[0.08] pb-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/48">
              Kullanıcıları, listeleri, yorumları ve temel platform metriklerini buradan takip edebilirsin.
            </p>
          </div>
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          <section className="rounded-2xl border border-white/[0.07] bg-white/[0.018] p-5">
            <h2 className="mb-4 text-lg font-black">Son Kullanıcılar</h2>
            {profiles.length === 0 ? (
          ...
          <section className="rounded-2xl border border-white/[0.07] bg-white/[0.018] p-5">
            <h2 className="mb-4 text-lg font-black">Son Listeler</h2>
            {lists.length === 0 ? (
          ...
          <section className="rounded-2xl border border-white/[0.07] bg-white/[0.018] p-5">
            <h2 className="mb-4 text-lg font-black">Son Yorumlar</h2>
            {reviews.length === 0 ? (
